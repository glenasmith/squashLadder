            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">Winner:</td>
                            
                            <td valign="top" class="value"><g:link controller="player" action="show" id="${gameInstance?.winner?.id}">${gameInstance?.winner?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name">Loser:</td>
                            
                            <td valign="top" class="value"><g:link controller="player" action="show" id="${gameInstance?.loser?.id}">${gameInstance?.loser?.encodeAsHTML()}</g:link></td>
